...
ROOT_URLCONF = 'kunfood.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'kunfood.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'client_admin.context_processors.admin_media_prefix',
    'client_admin.context_processors.admin_media_prefix'
...
SOCIAL_AUTH_FACEBOOK_KEY = '1377110769226170'
SOCIAL_AUTH_FACEBOOK_SECRET = 'daa182faed465a20ba85b0fde7f68bcb'
...
EMAIL_HOST_USER = 'informes@atixplus.com'
EMAIL_HOST_PASSWORD = 'informes1234'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
